...
jobs:
  ...
  deploy-docker:
    ...
    steps:
      ...
      - add_ssh_keys:
          fingerprints:
            - SHA256:NFuFIwf8Wk2ZYT4zPMTZ+KocSG2/sXzUWWlTpw0nnBE
      - run:
          name: Transfer Docker Image to EC2
          command: |
            scp -o StrictHostKeyChecking=no /home/circleci/deploy/moviefi-app.tar ubuntu@ec2-13-50-214-237.eu-north-1.compute.amazonaws.com:/home/ubuntu/moviefi-app.tar
      - run:
          name: Deploy Docker Image on EC2
          command: |
            ssh -o StrictHostKeyChecking=no ubuntu@ec2-13-50-214-237.eu-north-1.compute.amazonaws.com \
